...
class Avantio extends Controller
{
    // avantio
     ...
     * @return string
     */
    public function index($param = null , $environment = null)
    {

        /*
        # init helpers and others
        $this->init();


        # set environment database
        $this->setEnvironmentDb($environment);
        */
