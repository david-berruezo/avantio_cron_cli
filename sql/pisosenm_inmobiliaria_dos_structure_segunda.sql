...
CREATE TABLE `avantio_accomodations` (
  ...
  `text_userid` varchar(75) NOT NULL DEFAULT '' COMMENT 'Id usuario',
  `text_company` varchar(75) NOT NULL DEFAULT '' COMMENT 'Nombre compañia',
  `number_companyid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Id compañia',
  ...
  `text_tipo_piscina` varchar(255) NOT NULL DEFAULT '' COMMENT 'Tipo piscina',
  `checkbox_grups` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT 'grupos',
...
CREATE TABLE `dynamic_rooms` (
  ...
  `checkbox_destacado` int(11) DEFAULT NULL COMMENT 'destacado',
  `checkbox_venta` tinyint(4) DEFAULT NULL COMMENT 'venta',
  `checkbox_rentalia` int(11) DEFAULT NULL COMMENT 'rentalia',
  `text_2camas` text COMMENT '2 camas',
  `text_1cama_1` text COMMENT '1 cama',
  `text_1cama_2` text COMMENT '2 cama',
  `text_3camas` text COMMENT '3 cama',
  `text_4camas` text COMMENT '4 cama',
  `dynamic_galeriaspagina` varchar(45) DEFAULT NULL COMMENT 'galeria pagina',
